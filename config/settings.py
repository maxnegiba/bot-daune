...
if not DEBUG:
    ...
    CSRF_COOKIE_SECURE = True
    CSRF_COOKIE_HTTPONLY = False  # Needed for JS access if not in template tags, but usually JS reads via cookie library. standard django setup uses token from cookie.
